...
from meshdash.config import (
    ...
    DEFAULT_BOTS_ENABLED,
    DEFAULT_BOTS_DIRECTORY,
    DEFAULT_BOTS_EVENT_QUEUE_SIZE,
    DEFAULT_BOTS_FILES_DIRECTORY,
    DEFAULT_BOTS_HANDLER_TIMEOUT_SECONDS,
    DEFAULT_BOTS_STATE_DB,
...
def main() -> None:
    parser = _build_dashboard_parser_helper(
        ...
        default_bots_enable=DEFAULT_BOTS_ENABLED,
        default_bots_directory=DEFAULT_BOTS_DIRECTORY,
        default_bots_state_db=DEFAULT_BOTS_STATE_DB,
        default_bots_files_directory=DEFAULT_BOTS_FILES_DIRECTORY,
        default_bots_handler_timeout=DEFAULT_BOTS_HANDLER_TIMEOUT_SECONDS,
        ...
        env_bots_enable=os.environ.get("MESH_DASH_BOTS_ENABLE"),
        env_bots_directory=os.environ.get("MESH_DASH_BOTS_DIRECTORY"),
        env_bots_state_db=os.environ.get("MESH_DASH_BOTS_STATE_DB"),
        env_bots_files_directory=os.environ.get("MESH_DASH_BOTS_FILES_DIRECTORY"),
        env_bot_enable=os.environ.get("MESH_DASH_BOT_ENABLE"),
        env_bot_disable=os.environ.get("MESH_DASH_BOT_DISABLE"),
