...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    MESH_DASH_PLUGINS_ENABLE=1 \
    MESH_DASH_PLUGINS_DIRECTORY=/data/plugins \
    MESH_DASH_PLUGINS_STATE_DB=/data/plugin-state.sqlite3 \
    MESH_DASH_PLUGINS_FILES_DIRECTORY=/data/plugin-files
