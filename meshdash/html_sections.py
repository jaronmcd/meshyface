...
def build_html_shell(
    *,
    ...
    scripts_tab_hidden_attrs: str = "",
    scripts_section_hidden_attrs: str = "",
    apps_workspaces_title: str = "Games, Files, and Scripts workspaces",
    apps_workspaces_meta: str = "Games, files, and scripts",
