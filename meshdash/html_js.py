...
_DASHBOARD_JS_TEMPLATE_PARTS = (
    ...
    "dashboard.js.chat.events.data_views.node_details.nodes_table.tmpl",
    "dashboard.js.chat.events.data_views.node_details.helpers.tmpl",
    "dashboard.js.chat.events.data_views.node_details.view.tmpl",
    ...
    "dashboard.js.runtime.views.packet_channels.traffic_context.tmpl",
...
def build_dashboard_js(
    *,
    ...
    values = {
        ...
        "plugins_enabled": 1 if bool(plugins_enabled) else 0,
