...
_DASHBOARD_JS_TEMPLATE_PARTS = (
    ...
    "dashboard.js.chat.events.console.commands.core.tmpl",
    "dashboard.js.chat.events.console.commands.mappacks.tmpl",
    "dashboard.js.chat.events.console.commands.live.tmpl",
    "dashboard.js.chat.events.console.commands.history.tmpl",
    "dashboard.js.chat.events.console.commands.nodes.tmpl",
    "dashboard.js.chat.events.console.commands.network.tmpl",
