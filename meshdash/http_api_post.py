...
from .http_route_contracts import (
    ...
    SetPluginEnabledFn,
    SetPluginRoutePolicyFn,
    SetPluginRuntimeEnabledFn,
    SetPluginSettingsFn,
    SetThemePresetFn,
    ToIntFn,
)
...
def build_post_route_dependencies(
    *,
    ...
    set_plugin_route_policy_fn: SetPluginRoutePolicyFn | None = None,
    set_plugin_runtime_enabled_fn: SetPluginRuntimeEnabledFn | None = None,
    play_standalone_zork_fn: PlayStandaloneZorkFn | None = None,
    run_plugin_console_command_fn: RunPluginConsoleCommandFn | None = None,
    ...
    return DashboardPostRouteDependencies(
        ...
        set_plugin_route_policy_fn=set_plugin_route_policy_fn,
        set_plugin_runtime_enabled_fn=set_plugin_runtime_enabled_fn,
        ...
        run_plugin_console_command_fn=run_plugin_console_command_fn,
