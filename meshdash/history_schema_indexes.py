INDEX_SCHEMA_STATEMENTS = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_malformed_text_payloads_created_unix ON malformed_text_payloads(created_unix)",
    "CREATE INDEX IF NOT EXISTS idx_malformed_text_payloads_from_id ON malformed_text_payloads(from_id)",
    "CREATE INDEX IF NOT EXISTS idx_malformed_text_payloads_packet_id ON malformed_text_payloads(packet_id)",
