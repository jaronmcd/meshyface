...
DEFAULT_BBS_ENABLED = False
DEFAULT_FILE_TRANSFER_ENABLED = False
DEFAULT_ZORK_ENABLED = False
DEFAULT_FILE_TRANSFER_MAX_BYTES = 64 * 1024
MIN_FILE_TRANSFER_MAX_BYTES = 1024
MAX_FILE_TRANSFER_MAX_BYTES = 512 * 1024
