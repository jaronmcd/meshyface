...
DEFAULT_PLUGINS_DIRECTORY = "mesh_dashboard_plugins"
DEFAULT_PLUGINS_STATE_DB = "mesh_dashboard_plugin_state.sqlite3"
DEFAULT_PLUGINS_FILES_DIRECTORY = "mesh_dashboard_plugin_files"
DEFAULT_PLUGINS_HANDLER_TIMEOUT_SECONDS = 5.0
DEFAULT_PLUGINS_EVENT_QUEUE_SIZE = 128
