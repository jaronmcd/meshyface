...
DEFAULT_BOTS_ENABLED = False
DEFAULT_BOTS_DIRECTORY = "mesh_dashboard_plugins"
DEFAULT_BOTS_STATE_DB = "mesh_dashboard_plugin_state.sqlite3"
DEFAULT_BOTS_FILES_DIRECTORY = "mesh_dashboard_plugin_files"
DEFAULT_BOTS_HANDLER_TIMEOUT_SECONDS = 5.0
DEFAULT_BOTS_EVENT_QUEUE_SIZE = 128
