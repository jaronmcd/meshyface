...
def render_pr_comment(
    ...
    *,
    ...
    lines = [
        ...
        "## GUI smoke test",
        "",
        "Checks view switching, JavaScript errors, and basic responsiveness on an offline dashboard.",
    ]

    lines.extend(["", "This unpopulated workload does not measure performance improvements on a busy mesh."])
...
def render_markdown_report(
    ...
    lines = ["# Meshyface GUI smoke test", ""]
    lines.extend(
        _table(
            ["Field", "Value"],
            [
...
def main() -> int:
    ...
    if args.pr_comment_output:
        comment = render_pr_comment(result, run_url=args.run_url)
